...
// 		shoppingRepository.On("GetAllshopping", mock.AnythingOfType("string")).Return(&shoppingGetDatas, nil).Once()

// 		receivings, err := shoppingService.GetAllshopping(email)
...
// 		adminService.On("FindAdminByID", mock.AnythingOfType("string")).Return(&adminData, nil).Once()
// 		shoppingRepository.On("GetAllshopping", mock.AnythingOfType("string")).Return(nil, nil).Once()
// 		categories, err := shoppingService.GetAllshopping(email)
...
// func TestGetAllshoppingByParameter(t *testing.T) {
// 	t.Run("Expect Admin Not Found", func(t *testing.T) {
// 		adminService.On("FindAdminByID", mock.AnythingOfType("string")).Return(nil, business.ErrNotHavePermission).Once()
...
// 	t.Run("Expect found the data Purchase Receiving", func(t *testing.T) {
// 		adminService.On("FindAdminByID", mock.AnythingOfType("string")).Return(&adminData, nil).Once()
// 		shoppingRepository.On("GetAllshoppingByParameter", mock.AnythingOfType("string"), mock.AnythingOfType("string")).Return(&shoppingGetDatas, nil).Once()

// 		receivings, err := shoppingService.GetAllshoppingByParameter(code, email)
...
// 	t.Run("Expect data nil", func(t *testing.T) {
// 		adminService.On("FindAdminByID", mock.AnythingOfType("string")).Return(&adminData, nil).Once()
// 		shoppingRepository.On("GetAllshoppingByParameter", mock.AnythingOfType("string"), mock.AnythingOfType("string")).Return(nil, nil).Once()
// 		categories, err := shoppingService.GetAllshoppingByParameter(code, email)
